...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>JAINTIA HILL RESORT SYLHET</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:        url(../image/jainta1.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/jainta1.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/jainta1.jpg) no-repeat;  left:0px; top:0px;}
    40%  {background:url(../image/jainta2.jpg) no-repeat;  left:0px; top:0px;}
    60%  {background:url(../image/jainta2.jpg) no-repeat; left:0px; top:0px;}
    80%  {background:url(../image/jainta3.jpg) no-repeat;  left:0px; top:0px;}
    100% {background:url(../image/jainta3.jpg) no-repeat;  left:0px; top:0px;}
}
...
When planning on a trip to Sylhet, consider staying at Jaintia Hill resort, the perfect place for a tranquil retreat, ultimate relaxation and.......</p>
   ...
   <h3 class="description">Heartiest Welcome to the Ambiance of Elegance of the ‘GRAND ORIENTAL’ , a newly built 5-Star standard boutique Hotel at Gulshan-1, which is the centre of the major commercial hub of Dhaka. It is just a 20-Minutes drive away from the International Airport. The Headquarters of most of the Banks, Commercial & Industrial establishments, Important Foreign Missions & International Agencies, Shopping Centers and Parks are situated within a radius of just a few hundred meters from the Hotel. With its modern architectural grandeur, aesthetically designed Interior Decor, well trained & disciplined Staff. 3-Restaurants offering oriental and continental delicacies, Roof-Top Swimming Pool, Gym, Sauna, Round the clock room service, full WIFI & CCTV coverage provide convenience & security of our valued guests. </h3>
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">Sylhet</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">JAINTIA HILL RESORT </h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">10:05:00 PM</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">06:16:00 PM:</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">50 Km from airport</h3>
    </div>
    </div>
    ...
    <div  class="contentheaddiv">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 15500</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">Rs 11500</h3>
     </div>
     </div>
     <div class="eachbookitem1">
    ...
    <div class="mainbookitem">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 12000</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">Rs 8500</h3>
     </div>
     </div>
     <div class="eachbookitem2">
       <h3 class="booklineia">Available</h3>
    ...
    <div class="mainbookitem">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 13000</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">Rs 9500</h3>
     </div>
     </div>
     <div class="eachbookitem1">
       <h3 class="booklineia">Available</h3>
