...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>HOTEL AGRABAD CHITTAGONG</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:        url(../image/agrabad1.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/agrabad1.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/agrabad1.jpg) no-repeat;  left:0px; top:0px;}
    40%  {background:url(../image/agrabad2.jpg) no-repeat;  left:0px; top:0px;}
    60%  {background:url(../image/agrabad2.jpg) no-repeat; left:0px; top:0px;}
    80%  {background:url(../image/agrabad3.jpg) no-repeat;  left:0px; top:0px;}
    100% {background:url(../image/agrabad3.jpg) no-repeat;  left:0px; top:0px;}
}
...
<div id="wrap">
 ...
 <div id="gcontent">
  ...
  <li>
   ...
   You are most cordially Welcome to Hotel Agrabad Chittagong Bangladesh. Hotel Agrabad centrally air-conditioned and equipped.....
     <!--contentpopular ends here-->
        ...
        <h3 class="previous">Rs18000</h3>
        <h3 class="next">Rs15500</h3>
   ...
   <h3 class="description">You are most cordially Welcome to Hotel Agrabad Chittagong Bangladesh. Hotel Agrabad centrally air-conditioned and equipped, inter alia, with two large and elegant Lobbies- the Space to greet, meet and spend your disposable times and a Business Lounge provides your Secretarial needs. The 101 Luxurious Rooms and Suites outfitted with all modern amenities- cable TV, IDD and NWD Telephone, Well- stocked Mini Bar, in-room Safe. 24-hour Room Service etc.Hotel agrabad chittagong puts the following facilities and services at your disposal- Three Multi-Cuisine Restaurants, LIQUID Bar & Lounge, OASIS Arabian Restaurant, Active8 Health & Fitness. AQUA Blu Swimming Pool, SIAM Thai SPA, Billiard and Snooker Game. For Conferences, Corporate Events and Social Get-together, the spacious lchamati Hall, Mini Conference Room .</h3>
    </div> 
         <!--googlemap ends here-->
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">HOTEL AGRABAD</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">03:10:00 AM</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">11:10:00 PM:</h3>
    </div>
    </div>
    ...
    <div  class="contentheaddiv">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 20500</h3></div>
     <div class="lprice">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 21500</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">Rs 19000</h3>
     </div>
     </div>
     <div class="eachbookitem2">
       <h3 class="booklineia">Available</h3>
    ...
    <div class="mainbookitem">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 19000</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">Rs 17000</h3>
     </div>
     </div>
     <div class="eachbookitem1">
       <h3 class="booklineia">Available</h3>
