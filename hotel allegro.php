...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>ALLEGRO HOLIDAY SUITES COX'S BAZAR</title>
  ...
  <li>
    ...
    <div id="grightusable">
        ...
        <p class="popularp"> <em class="adrs"> Kalatoli,Cox's Bazar</em> <em class="emp"> 15 Km Distance from airport</em> <br />
          Allegro Holiday Suites Cox's bazar is the most modern and furnished with the branded fixture of 25 suite rooms in Cox&amp;rsquo;s Bazar. This exclusive boutique style hotel is located in ...
    ...
    <h3 class="description">Allegro Holiday Suites Cox's bazar is the most modern and furnished with the branded fixture of 25 suite rooms in Cox’s Bazar. This exclusive boutique style hotel is located in walking distance from both Laboni beach and Sugandha beach, in a convenient location with a view to offer best services to its valued clients and offers convenient access to many interesting sights within close vicinity. A world class amenity for you, Allegro Holiday Suites, is placed in the Tourism Capital of Bangladesh, Cox’s Bazar. Our exclusive hospitality, management and stunning design will always make your holiday enjoyable every moment.</h3>
         </div> 
         <!--googlemap ends here-->
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description"> ALLEGRO HOLIDAY</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">14:35:00 AM</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">12:25:00 AM:</h3>
    </div>
    </div>
