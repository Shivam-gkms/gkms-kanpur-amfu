...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>Hotel Victory,Dhaka</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:        url(../image/victory1.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/victory1.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/victory1.jpg) no-repeat;  left:0px; top:0px;}
    ...
    80%  {background:url(../image/victory3.jpg) no-repeat;  left:0px; top:0px;}
    100% {background:url(../image/victory3.jpg) no-repeat;  left:0px; top:0px;}
}
 ...
 <div id="gcontent">
  ...
  <li>
    ...
    <div id="grightusable">
        ...
        <p class="popularp"><em class="adrs">Naya Paltan,Dhaka</em><em class="emp">16 Km Distance from airport</em> <br />
  This is one of the few hotels that is situated near the commercial hub of the city, Motijheel.Opened in 2006, it has 74 rooms. The room types vary from premier....</p>
   ...
   <h3 class="description">This is one of the few hotels that is situated near the commercial hub of the city, Motijheel.<br />
     Opened in 2006, it has 74 rooms. The room types vary from premier, deluxe to deluxe family room and suites. The in-room facilities include minibar, freeze, cable TV, 24-hours room service and internet.<br />
     The boarders are also offered the services of beauty salon, rent-a-car, business center and fitness center.<br />
     There are restaurants, namely Karnaphuli (regular buffet lunch &amp; dinner, international cuisine), Coffee shop (tea, coffee, snacks and buffet breakfast), Banquet Hall and Victory Conference Room are designated for meetings and conferences.</h3>
    </div> 
         <!--googlemap ends here-->
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">HOTEL VICTORY</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">06:01:00 PM:</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">16 Km from airport</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description"> Free LAN and WiFi </h3>
    </div>
    </div>
    ...
    <div  class="contentheaddiv">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 19500</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">Rs 17500</h3>
     </div>
     </div>
     <div class="eachbookitem1">
