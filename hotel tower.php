...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>HOTEL TOWER INN CHITTAGONG</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:        url(../image/asia1.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/asia1.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/asia1.jpg) no-repeat;  left:0px; top:0px;}
    40%  {background:url(../image/victory2.jpg) no-repeat;  left:0px; top:0px;}
    60%  {background:url(../image/victory2.jpg) no-repeat; left:0px; top:0px;}
    80%  {background:url(../image/well3.jpg) no-repeat;  left:0px; top:0px;}
    100% {background:url(../image/well3.jpg) no-repeat;  left:0px; top:0px;}
}
 ...
 <div id="gcontent">
  ...
  <li>
    ...
    <div id="grightusable">
        ...
        <p class="popularp"> <em class="adrs">Jubilee Road,Chittagong</em> <em class="emp"> 20 Km Distance from airport</em> <br />
Hotel Tower Inn International Ltd. is spectacularly designed and added with traditional hospitality of courteous, attractive and personalized service and is conveniently locate......<!--contentpopular ends here-->
        ...
        <h3 class="previous">Rs13000</h3>
        <h3 class="next">Rs10000</h3>
   ...
   <h3 class="description">Hotel Tower Inn International Ltd. is spectacularly designed and added with traditional hospitality of courteous, attractive and personalized service and is conveniently located in the heart of the city - Jubilee Road of Chittagong at a distance of 20 kilometers from Shah Amanat International Airport and 3 kilometers from railway station. Hotel Tower Inn offers magnificent facilities and distinctive amenities, such as 88 centrally air-conditioned rooms including 8 royal suites, 26 Deluxe single, 32 Royal single, 22 Luxury Twin, and Green Chili Restaurant.
Hotel Tower Inn has 110 well-furnished rooms in operation right now having a Spacious having an informal coffee shop cum Restaurant, a Business Center, and a mini conference hall. Rooms having bath tub/ bath tray, running Hot and cold water, TV in every room, room to room call service, 2 Elevators, 24 hrs room service, freeze.</h3>
    </div> 
         <!--googlemap ends here-->
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">Chittaging</h3>
    </div>
    </div>
    ...
    <div class="sis">HOTEL TOWER INN</div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">18:09:00 AM</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">17:08:00 PM:</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">30 Km from airport</h3>
    </div>
    </div>
    ...
    <div  class="contentheaddiv">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 17000</h3></div>
     <div class="lprice">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 17500</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">Rs 14500</h3>
     </div>
     </div>
     <div class="eachbookitem2">
       <h3 class="booklineia">Available</h3>
    ...
    <div class="mainbookitem">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 13500</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">Rs 10500</h3>
     </div>
     </div>
     <div class="eachbookitem1">
       <h3 class="booklineia">Available</h3>
