...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>HOTEL FORTUNE GARDEN SYLHET</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:    url(../image/fortune1.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/fortune1.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/fortune1.jpg) no-repeat;  left:0px; top:0px;}
    40%  {background:url(../image/fortune2.jpg) no-repeat;  left:0px; top:0px;}
    60%  {background:url(../image/fortune2.jpg) no-repeat; left:0px; top:0px;}
    80%  {background:url(../image/fortune3.jpg) no-repeat;  left:0px; top:0px;}
    100% {background:url(../image/fortune3.jpg) no-repeat;  left:0px; top:0px;}
}
...
Heartiest Welcome to the Ambiance of Elegance of the ‘GRAND ORIENTAL’ , a newly built 5-Star standard boutique...</p>
   ...
   <h3 class="description">Welcome to the Magnificent Hotel Fortune Garden, a Modern new exclusive Hotel in the heart of Sylhet, a city with a holy shrine, greenery tea garden, wonderful water fall and lots of cultural activities, it makes one of the most attractive tourist cities in Bangladesh.<br />
     With state-of-the art foreign interior and all other facilities, its makes our hotel most modern equipped in the city.<br />
     By focusing on combining unparalleled levels of service with class-leading facilities, the Fortune Garden aims to provide customers with a unique and truly memorable experience. In addition, we will bring extraordinary value to the fast growing hospitality sector.<br />
     With so much to offer Hotel Fortune Garden is the &lsquo;jewel of Sylhet&rsquo;.</h3>
    </div> 
         <!--googlemap ends here-->
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">HOTEL FORTUNE</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">23:11:00 PM</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">09:05:00 PM:</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">25 Km from airport</h3>
    </div>
    </div>
    ...
    <div  class="contentheaddiv">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 18500</h3></div>
     <div class="lprice">
