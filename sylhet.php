...
Sylhet is a prominent Islamic spiritual centre and home to numerous Sufi shrines. The Sylhet Division produces most of Bangladesh's tea yield and natural gas. It is also known for its cane, citrus, timber and agarwood.Sylhet is a major recipient of remittances from the Bangladeshi diaspora, particularly from the United Kingdom.The city is served by the Osmani International Airport. It is connected to the Port of Chittagong by the N2 and the Bangladesh Railway. The Bangladesh-India border in Tamabil is located to the north of the city. Sylhet is also home to the Shahjalal University of Science and Technology
   ...
   <div class="googleMap">
    ...
    <div id="popularheaddiv">
     <h3 class="contentheadline">SYLHET HOTELS</h3> 
     </div><!--popularheaddiv ends here-->
     <div id="populardiv">
     <div id="allpopular">
     
        <div class="eachpopular">
        <a href="hotel fortune.php">
        <div class="threepopular">
        <div class="imgpopular">
        <div class ="imgpopulardiv">
        <img class="popimg" src="../image/hotel fortune.jpg" alt=""/>
        </div> <!--imgpopulardiv ends here-->
        </div> <!--imgpopular ends here-->
        <div class="contentpopular">
        <h5 class="popularheadline">HOTEL FORTUNE GARDEN SYLHET</h5>
        <p class="popularp"> <em class="adrs">Naiorpul,Sylhet</em> <em class="emp"> 25 Km Distance from airport</em> <br />
          Welcome to the Magnificent Hotel Fortune Garden, a Modern new exclusive Hotel in the heart of Sylhet, a city with a holy shrine, greenery tea garden....</p>
...
<div class="eachpopular">
        <a href="hotel rose.php">
        <div class="threepopular">
        <div class="imgpopular">
        <div class ="imgpopulardiv">
        <img class="popimg" src="../image/hotel rose.jpg" alt=""/>
        </div> <!--imgpopulardiv ends here-->
        </div> <!--imgpopular ends here-->
        <div class="contentpopular">
        <h5 class="popularheadline">HOTEL ROSE VIEW SYLHET</h5>
        <p class="popularp"> <em class="adrs">Shahjalal UposhoHor,Sylhet</em> <em class="emp"> 10 Km Distance from airport</em> <br />
          Hotel Rose View welcomes you to enjoy comfort and luxury, a place where you will find exceptional five star facilities from pleasant surroundings and....</p>
        </div><!--contentpopular ends here-->
        <div class="ratingpop">
        <div class="ratingpoptop">
        <div class="four">
        ...
        <div class="eachpopular">
        <a href="hotel star.php">
        <div class="threepopular">
        <div class="imgpopular">
        <div class ="imgpopulardiv">
        <img class="popimg" src="../image/hotel star.jpg" alt=""/>
        </div> <!--imgpopulardiv ends here-->
        </div> <!--imgpopular ends here-->
        <div class="contentpopular">
        <h5 class="popularheadline">HOTEL STAR PACIFIC SYLHET</h5>
        <p class="popularp"><em class="adrs">East Dorgah Gate, Sylhet<em class="emp">15 Km Distance from airport</em></em> <br />
          Hotel Star Pacific welcomes you to the city of the great saint Hazrat Shahjalal. Hotel Star Pacific is situated at the heart of the city and very close to most of the local.....</p>
        </div><!--contentpopular ends here-->
        <div class="ratingpop">
        <div class="ratingpoptop">
        <div class="four">
       ...
       <div class="eachpopular">
        <a href="hotel jaintia.php">
        <div class="threepopular">
        <div class="imgpopular">
        <div class ="imgpopulardiv">
        <img class="popimg" src="../image/hotel jaintia.jpg" alt=""/>
        </div> <!--imgpopulardiv ends here-->
        </div> <!--imgpopular ends here-->
        <div class="contentpopular">
        <h5 class="popularheadline">JAINTIA HILL RESORT SYLHET</h5>
        <p class="popularp"> <em class="adrs">Tamabil,Sylhet  </em> <em class="emp"> 50 Km Distance from airport</em> <br />
          When planning on a trip to Sylhet, consider staying at Jaintia Hill resort, the perfect place for a tranquil retreat, ultimate relaxation and......</p>
        </div><!--contentpopular ends here-->
        <div class="ratingpop">
        <div class="ratingpoptop">
        <div class="three">
        ...
        <div class="ratingpopbot">
        <h3 class="previous">Rs12000</h3>
        <h3 class="next">Rs8500</h3>
        </div> <!--ratingpopbot ends here-->
        </div> <!--ratingpop ends here-->
        </div> <!--threepopular ends here-->
        </a>
      ...
      <div class="eachpopular">
        <a href="hotel nazim.php">
        <div class="threepopular">
        <div class="imgpopular">
        <div class ="imgpopulardiv">
        <img class="popimg" src="../image/hotel nazim.jpg" alt=""/>
        </div> <!--imgpopulardiv ends here-->
        </div> <!--imgpopular ends here-->
        <div class="contentpopular">
        <h5 class="popularheadline">SYLHET NAZIMGARH RESORT</h5>
        <p class="popularp"> <em class="adrs">Kotwali,Sylhet</em> <em class="emp"> 15 Km Distance from airport</em> <br />
          Nazimgarh Resort is everything a resort should be. Set on six acres of landscaped hillside, Nazimgarh Resort is a self contained island of tranquillity amidst......</p>
        </div><!--contentpopular ends here-->
        <div class="ratingpop">
        <div class="ratingpoptop">
        <div class="four">
