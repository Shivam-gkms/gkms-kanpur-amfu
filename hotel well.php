...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>HOTEL WELL PARK CHITTAGONG</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:        url(../image/well1.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/well1.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/well1.jpg) no-repeat;  left:0px; top:0px;}
    40%  {background:url(../image/well2.jpg) no-repeat;  left:0px; top:0px;}
    60%  {background:url(../image/well2.jpg) no-repeat; left:0px; top:0px;}
...
<div id="wrap">
 ...
 <div id="gcontent">
  ...
  <li>
    ...
    The business hotel in chittagong with luxurious rooms and suites, restaurants, rooftop dining, business centre and other business facilities....
   ...
   <h3 class="description">The business hotel in chittagong with luxurious rooms and suites, restaurants, rooftop dining, business centre and other business facilities. At Well Park Residence, Chittagong, you'll find all that you need to make the most of your stay exciting and comfortable. An ideal residence for discerning travelers who appreciate the finer things in life, you can look forward to a host of excellent business and leisure facilities.</h3>
    </div> 
         <!--googlemap ends here-->
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">HOTEL WELL PARK</h3>
    </div>
    </div>
