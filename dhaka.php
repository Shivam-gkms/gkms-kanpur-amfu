 ...
 <div id="content">
  ...
  <li>
    ...
    <div class="contentheaddiv">
    	<h3 class="contentheadline">DHAKA CITY</h3>
     </div>  
     <div class="cityname">
     <p>
    Dhaka is also known as Dacca, especially formerly  is the capital city of Bangladesh. It is the headquarters of Dhaka Division and Dhaka District. Standing on the east bank of the Buriganga River, Dhaka is the political, economic and cultural heart of Bangladesh. It is one of the major cities of South Asia. Historically known as the City of Mosques, it is also nicknamed as the Rickshaw Capital of the World, with its daily traffic of over 500,000 cycle rickshaws.<br/>In recent decades, Dhaka has been experiencing an influx of people from across the nation, making it one of the fastest growing metropolitan areas in the world. The city has been attracting greater volumes of foreign investment and trade; and has been witnessing the modernization of transport and communications, with the Dhaka Metro and the Dhaka Elevated Expressway under construction. </p>
     </div> 
   ...
   <div class="googleMap">
    ...
    <div id="popularheaddiv">
     <h3 class="contentheadline">DHAKA HOTELS</h3> 
     </div><!--popularheaddiv ends here-->
     <div id="populardiv">
     <div id="allpopular">
     
        <div class="eachpopular">
        <a href="grandorient.php">
        <div class="threepopular">
        <div class="imgpopular">
        <div class ="imgpopulardiv">
        <img class="popimg" src="../image/pop.jpg" alt=""/>
        </div> <!--imgpopulardiv ends here-->
        </div> <!--imgpopular ends here-->
        <div class="contentpopular">
        <h5 class="popularheadline">GRAND ORIENTAL HOTEL</h5>
        <p class="popularp"> <em class="adrs">Gulshan-1, Dhaka-1212</em> <em class="emp"> 8 Km Distance from airport</em> <br />
Heartiest Welcome to the Ambiance of Elegance of the ‘GRAND ORIENTAL’ , a newly built 5-Star standard boutique...</p>
...
<div class="eachpopular">
        ...
        <div class="eachpopular">
        <a href="hotel victory.php">
        <div class="threepopular">
        <div class="imgpopular">
        <div class ="imgpopulardiv">
        <img class="popimg" src="../image/hotel victory.jpg" alt=""/>
        </div> <!--imgpopulardiv ends here-->
        </div> <!--imgpopular ends here-->
        <div class="contentpopular">
        <h5 class="popularheadline">HOTEL VICTORY DHAKA</h5>
        <p class="popularp"><em class="adrs">Naya Paltan,Dhaka <em class="emp">16 Km Distance from airport</em></em> <br />
          This is one of the few hotels that is situated near the commercial hub of the city, Motijheel.Opened in 2006, it has 74 rooms. The room types vary from premier....</p>
        </div><!--contentpopular ends here-->
        <div class="ratingpop">
        <div class="ratingpoptop">
        <div class="five">
        ...
        <div class="ratingpopbot">
        <h3 class="previous">Rs17000</h3>
        <h3 class="next">Rs15000</h3>
        </div> <!--ratingpopbot ends here-->
        </div> <!--ratingpop ends here-->
        </div> <!--threepopular ends here-->
        </a>
       ...
       <div class="eachpopular">
        <a href="asia pacific.php">
        <div class="threepopular">
        <div class="imgpopular">
        <div class ="imgpopulardiv">
        <img class="popimg" src="../image/asia.jpg" alt=""/>
        </div> <!--imgpopulardiv ends here-->
        </div> <!--imgpopular ends here-->
        <div class="contentpopular">
        <h5 class="popularheadline">ASIA PACIFIC BLOSSOM HOTEL DHAKA</h5>
        <p class="popularp"> <em class="adrs">Dhaka  </em> <em class="emp"> 10 Km Distance from airport</em> <br />
          We are happy to announce that Asia Pacific Blossom Hotel just opened on November 01,2001. Its 36 Luxurious rooms including 10 suites....</p>
        </div><!--contentpopular ends here-->
        <div class="ratingpop">
        <div class="ratingpoptop">
        <div class="three">
      ...
      <div class="eachpopular">
        <a href="summer palace.php">
        <div class="threepopular">
        <div class="imgpopular">
        <div class ="imgpopulardiv">
        <img class="popimg" src="../image/summer palace.jpg" alt=""/>
        </div> <!--imgpopulardiv ends here-->
        </div> <!--imgpopular ends here-->
        <div class="contentpopular">
        <h5 class="popularheadline">SUMMER PALACE HOTEL AND APARTMENT</h5>
        <p class="popularp"> <em class="adrs">Baridhara,Dhaka-1212</em> <em class="emp"> 9 Km Distance from airport</em> <br />
          Summer Palace Hotel and Apartment is an exclusive international class hotel conveniently located in the diplomatic....</p>
        </div><!--contentpopular ends here-->
        <div class="ratingpop">
        <div class="ratingpoptop">
        <div class="four">
