   ...
   <div class="googleMap">
    ...
    <div id="popularheaddiv">
     ...
     <div id="allpopular">
        ...
        <h3 class="previous">20000</h3>
        <h3 class="next">16500</h3>
...
<div class="eachpopular">
        ...
        <div class="ratingpopbot">
        <h3 class="previous">19000</h3>
        <h3 class="next">15500</h3>
        </div> <!--ratingpopbot ends here-->
        </div> <!--ratingpop ends here-->
        </div> <!--threepopular ends here-->
        </a>
        ...
        <div class="ratingpopbot">
        <h3 class="previous">13000</h3>
        <h3 class="next">10500</h3>
        </div> <!--ratingpopbot ends here-->
        </div> <!--ratingpop ends here-->
        </div> <!--threepopular ends here-->
        </a>
       ...
       <div class="eachpopular">
        ...
        <div class="ratingpopbot">
        <h3 class="previous">16000</h3>
        <h3 class="next">12500</h3>
        </div> <!--ratingpopbot ends here-->
        </div> <!--ratingpop ends here-->
        </div> <!--threepopular ends here-->
        </a>
      ...
      <div class="eachpopular">
        ...
        <div class="ratingpopbot">
        <h3 class="previous">17000</h3>
        <h3 class="next">14000</h3>
        </div> <!--ratingpopbot ends here-->
        </div> <!--ratingpop ends here-->
        </div> <!--threepopular ends here-->
        </a>
