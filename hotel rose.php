...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>HOTEL ROSE VIEW SYLHET</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:        url(../image/rose1.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/rose1.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/rose1.jpg) no-repeat;  left:0px; top:0px;}
...
<div id="wrap">
 ...
 Hotel Rose View welcomes you to enjoy comfort and luxury, a place where you will find exceptional five star facilities from pleasant surroundings and....</p>
   ...
   <h3 class="description">Hotel Rose View welcomes you to enjoy comfort and luxury, a place where you will find exceptional five star facilities from pleasant surroundings and world class hospitality.<br />
     <br />
     Hotel Rose View features 140 cozy deluxe and suite rooms, an extensive array of restaurant outlets, fully equipped fitness center, swimming pool and other entertainment facilities.</h3>
    </div> 
         <!--googlemap ends here-->
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">HOTEL ROSE VIEW</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">13:07:00 AM</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">13:07:00 PM:</h3>
    </div>
    </div>
