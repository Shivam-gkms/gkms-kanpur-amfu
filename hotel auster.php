...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>HOTEL AUSTER ECHO COX'S BAZAR</title>
...
@-webkit-keyframes myfirst {
    ...
    40%  {background:url(../image/rose2.jpg) no-repeat;  left:0px; top:0px;}
    60%  {background:url(../image/rose2.jpg) no-repeat; left:0px; top:0px;}
    80%  {background:url(../image/rose3.jpg) no-repeat;  left:0px; top:0px;}
    100% {background:url(../image/rose3.jpg) no-repeat;  left:0px; top:0px;}
}
 ...
 <div id="gcontent">
  ...
  <li>
    ...
    <div id="grightusable">
        ...
        <p class="popularp"> <em class="adrs"> Kolatoli Road,Cox's Bazar</em> <em class="emp"> 3 Km Distance from airport</em> <br />
         Hotel Auster echo offers deluxe accommodation with 65 well decorated rooms.The panoramic view of the ocean,the majestic hills and the natural beauty of the heaven....
    ...
    <h3 class="description">Hotel Auster echo offers deluxe accommodation with 65 well decorated rooms.The panoramic view of the ocean,the majestic hills and the natural beauty of the heaven of tourism are all wonderfully complemented by Bangladeshi hospitality. This hotel stands out from the rest with its architectural beauty - both from inside and outside. As soon as you get in, you will experience a cozy and warm atmosphere that puts you at ease immediately. The staffs are very well mannered, friendly and are ready to help you out any time. Even though it is not located near to the sea beach, the top floors on the sea side can give you a clear view to the wide open Bay of Bengal. The foods are decent .The hotel is ideal for business and as well as family vacations.</h3>
         </div> 
         <!--googlemap ends here-->
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description"> AUSTER ECHO</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">3 Km from airport</h3>
    </div>
    </div>
    ...
    <div class="mainbookitem">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 14500</h3></div>
     <div class="lprice">
