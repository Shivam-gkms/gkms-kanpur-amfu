...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>SYLHET NAZIMGARH RESORT</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:        url(../image/nazim1.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/nazim1.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/nazim1.jpg) no-repeat;  left:0px; top:0px;}
    40%  {background:url(../image/nazim2.jpg) no-repeat;  left:0px; top:0px;}
    60%  {background:url(../image/nazim2.jpg) no-repeat; left:0px; top:0px;}
    80%  {background:url(../image/nazim3.jpg) no-repeat;  left:0px; top:0px;}
    100% {background:url(../image/nazim3.jpg) no-repeat;  left:0px; top:0px;}
}
...
<div id="wrap">
 ...
 <div id="gcontent">
  ...
  <li>
   ...
   Nazimgarh Resort is everything a resort should be. Set on six acres of landscaped hillside, Nazimgarh Resort is a self contained island of tranquillity amidst......
   ...
   <h3 class="description">Nazimgarh Resort is everything a resort should be. Set on six acres of landscaped hillside, Nazimgarh Resort is a self contained island of tranquillity amidst lush green foliage. It consists of the Terrace, the Villa and the Bungalow with fifty luxurious world class double rooms and suites.<br />
     With most rooms having jacuzzis, balconies and sundecks, Nazimgarh Resort is designed for individual and collective privacy.Well appointed rooms for board meetings, small exclusive conferences, retreats, executive training, make it the ideal destination for corporates of repute. Only thirty five minutes by air and four and half hours by road from Dhaka, Nazimgarh, the region&rsquo;s only true luxury resort, is the new destination for discerning travellers.</h3>
    </div> 
         <!--googlemap ends here-->
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">NAZIMGARH RESORT</h3>
    </div>
    </div>
