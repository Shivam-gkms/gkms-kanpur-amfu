...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>HOTEL OCEAN PARADISE COX'S BAZAR</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:        url(../image/ocean1.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/ocean1.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/ocean1.jpg) no-repeat;  left:0px; top:0px;}
    40%  {background:url(../image/ocean2.jpg) no-repeat;  left:0px; top:0px;}
    60%  {background:url(../image/ocean2.jpg) no-repeat; left:0px; top:0px;}
    80%  {background:url(../image/ocean3.jpg) no-repeat;  left:0px; top:0px;}
    100% {background:url(../image/ocean3.jpg) no-repeat;  left:0px; top:0px;}
}
  ...
  <li>
    ...
    <div id="grightusable">
        ...
        <p class="popularp"> <em class="adrs"> Kolatoli Road,Cox's Bazar</em> <em class="emp"> 15 Km Distance from airport</em> <br />
            Awaken to a tropical sea view as the light spills into your room and across your bed. Spend the day basking in the sun or exploring other......
    ...
    <h3 class="description">Awaken to a tropical sea view as the light spills into your room and across your bed. Spend the day basking in the sun or exploring other sights and sounds on the mountains, the Buddhist monasteries, or coral reef islands. At Ocean Paradise Hotel & Resort, we invite you to start each day immersed in the natural beauty of Cox's Bazar, a fishing port, and the town with the world's longest natural sandy beach. With first-class restaurants, affordable luxury accommodation and a spectacular view of the ocean, this tropical resort hotel offers a holiday experience unlike any other. You can indulge in some well-deserved relaxation at the renowned Spa, offering a whole range of spa treatments and massages. If you are a business guest, you can avail of state-of-the-art conference facilities combined with a touch of opulence and comfort. </h3>
         </div> 
         <!--googlemap ends here-->
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">  OCEAN PARADISE</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">18:18:00 AM</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">15:59:00 PM:</h3>
    </div>
    </div>
    ...
    <div  class="contentheaddiv">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 21000</h3></div>
     <div class="lprice">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 22000</h3></div>
     <div class="lprice">
