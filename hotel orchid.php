...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>CHITTAGONG ORCHID BUSINESS HOTEL</title>
...
@-webkit-keyframes myfirst {
    ...
    80%  {background:url(../image/summar1.jpg) no-repeat;  left:0px; top:0px;}
    100% {background:url(../image/summar1.jpg) no-repeat;  left:0px; top:0px;}
}
 ...
 <div id="gcontent">
  ...
  <li>
    ...
    <div id="grightusable">
     ...
     With the promising future of Bangladeshi economy and an optimism to instigate further growth in this fast placed industry, Orchid Business Hotel sets....
   ...
   <h3 class="description">With the promising future of Bangladeshi economy and an optimism to instigate further growth in this fast placed industry, Orchid Business Hotel sets out to create this three star business boutique hotel of international standard for business travelers and tourist to stay with the touch of majestic atmosphere.
<br />
After opening its soft operation in February 2011 with all modern facilities along with quality & time-bound service, Orchid Business Hotel offers excellent hospitality to enjoy the wonderful feelings of total relaxation.</h3>
    </div> 
         <!--googlemap ends here-->
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">ORCHID BUSINESS</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">22:05:00 AM</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">13:12:00 PM:</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">40 Km from airport</h3>
    </div>
    </div>
