...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>Grand Orient hotel,Dhaka</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:        url(../image/grand1.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/grand1.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/grand1.jpg) no-repeat;  left:0px; top:0px;}
    40%  {background:url(../image/grand2.jpg) no-repeat;  left:0px; top:0px;}
    60%  {background:url(../image/grand2.jpg) no-repeat; left:0px; top:0px;}
    80%  {background:url(../image/grand3.jpg) no-repeat;  left:0px; top:0px;}
    100% {background:url(../image/grand3.jpg) no-repeat;  left:0px; top:0px;}
}
...
Heartiest Welcome to the Ambiance of Elegance of the ‘GRAND ORIENTAL’ , a newly built 5-Star standard boutique...</p>
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">GRAND ORIENTAL</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">8 Km from airport</h3>
    </div>
    </div>
