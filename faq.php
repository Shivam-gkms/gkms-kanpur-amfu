...
<div id="FAQcontent" style="height:350px;">
    ...
    <div id="faqhead" style="float:left; width:40%; margin-left:170px; margin-top:120px;">
      <h2 style="color:red;font-weight:lighter;font-family:Arial, Helvetica, sans-serif;margin-left:100px;" >This Page is under Processing</h2>
    </div>
    <div id="faqimg" style="float:right;width:42%; background:url(../image/contact.jpg) no-repeat;height:350px;">   </div>
  
  </div>
     <div id="faqgoogle" style="width:1134px; height:200px;margin:auto; margin-bottom:50px;border:2px solid #CCC;
     								padding:5px;">
  </div>
  <!--content ends here--> 
