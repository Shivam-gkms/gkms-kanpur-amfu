...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>HOTEL SAINT MARTIN CHITTAGONG</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:        url(../image/asia2.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/asia2.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/asia2.jpg) no-repeat;  left:0px; top:0px;}
...
<div id="wrap">
 ...
 <div id="gcontent">
  ...
  It is a hotel, which the management claims to be an ideal home away from home.Hotel Saint Martin with its prime Magnificent Mile location is the....
   ...
   <h3 class="description">It is a hotel, which the management claims to be an ideal home away from home.<br />
     Hotel Saint Martin with its prime Magnificent Mile location is the perfect choice for your stay in the &quot;Chittagong City&quot;. The warmest of welcomes awaits you from a dedicated team who make it their business to make sure your stay is a perfect one.<br />
     This 74-room hotel opened in 1991. The rooms are deluxe rooms and suites.</h3>
    </div> 
         <!--googlemap ends here-->
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">HOTEL SAINT MARTIN</div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">08:10:00 AM</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">12:13:00 PM:</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">17 Km from airport</h3>
    </div>
    </div>
