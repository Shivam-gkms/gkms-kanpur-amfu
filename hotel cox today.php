...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>HOTEL THE COX'S TODAY</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:        url(../image/nazim3.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/nazim3.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/nazim3.jpg) no-repeat;  left:0px; top:0px;}
    40%  {background:url(../image/cox2.jpg) no-repeat;  left:0px; top:0px;}
    60%  {background:url(../image/cox2.jpg) no-repeat; left:0px; top:0px;}
 ...
 <div id="gcontent">
  ...
  <li>
    ...
    <div id="grightusable">
      ...
      Hotel The Cox Today is one of the best five-star standard luxury hotel in Cox's Bazar. It's magnificent and uniquely located along the world's.....
        ...
        <h3 class="previous">Rs20000</h3>
        <h3 class="next">Rs16500</h3>
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description"> COX'S TODAY</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">20 Km from airport</h3>
    </div>
    </div>
    ...
    <div  class="contentheaddiv">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 23000</h3></div>
     <div class="lprice">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 24000</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">Rs 19500</h3>
     </div>
     </div>
     <div class="eachbookitem2">
       <h3 class="booklineia">Available</h3>
