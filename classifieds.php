...
<link rel="stylesheet" href="../css/index.css">
	 <title>Classifieds hotels</title>
 ...
 <div id="content">
  ...
  <li>
    ...
    <div class="contentheaddiv">
    	<h3 class="contentheadline">CLASSIFIED HOTELS</h3>
     </div>  
     <div class="cityname">
     <p>
       1. Here, you get the list of hotels at lowest price.
       <br/>
       2. Hotels are enlisted from all of the categories.
       <br/>
       Categories are:<br/>
      &nbsp; &nbsp; DHAKA<br/>
      &nbsp; &nbsp; CHITTAGONG<br/>
      &nbsp; &nbsp; SYLHET<br/>
       &nbsp; &nbsp;COX'S BAZAR<br/>
       3. For instance, one of the most cheapest hotels in Bangladesh is HOTEL SAINT MARTIN CHITTAGONG. Here, you can easily check the rate and compare with other hotels.
   ...
   <div class="googleMap">
    ...
    <div id="popularheaddiv">
     <h3 class="contentheadline">HOTELS AT CHEAP RATE</h3> 
