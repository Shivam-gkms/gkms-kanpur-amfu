...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>Summar palace hotel,Dhaka</title>
 ...
 div#himage
{
	...
	height: 448px;
    background:        url(../image/summar1.jpg) no-repeat;
...
@-webkit-keyframes myfirst {
    0%   {background:url(../image/summar1.jpg) no-repeat; left:0px; top:0px;}
    20%  {background:url(../image/summar1.jpg) no-repeat;  left:0px; top:0px;}
    40%  {background:url(../image/summar2.jpg) no-repeat;  left:0px; top:0px;}
    60%  {background:url(../image/summar2.jpg) no-repeat; left:0px; top:0px;}
    80%  {background:url(../image/summar3.gif) no-repeat;  left:0px; top:0px;}
    100% {background:url(../image/summar3.gif) no-repeat;  left:0px; top:0px;}
}
...
<div id="wrap">
 ...
 <div id="gcontent">
  ...
  <li>
   ...
   <h3 class="description">Summer Palace Hotel and Apartment is an exclusive international class hotel conveniently located in the diplomatic enclave of Bangladesh and only 5 to 10 minutes drive from Zia International Airport.<br />
     Summer Palace Hotel and Apartment is also in close proximity to the foreign embassies, office, shopping &amp; entertainment areas located at Gulshan, Banani and Baridhara. Whether for business or leisure, Summer Palace Hotel &amp; Apartments is the ideal place that can fully serve your needs.<br />
     As soon as you step into the reception area, the unique yet sophisticated decor enfolds you and our warmth and hospitality is such that you truly feel as if you are still at home.</h3>
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">SUMMAR PALACE</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">9 Km from airport</h3>
    </div>
    </div>
