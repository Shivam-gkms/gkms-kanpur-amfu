...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <link rel="stylesheet" href="../css/index.css">
	 ...
	 <title>Asia Pacific Blossom Hotel Dhaka</title>
...
@-webkit-keyframes myfirst {
    ...
    40%  {background:url(../image/asia2.jpg) no-repeat;  left:0px; top:0px;}
    60%  {background:url(../image/asia2.jpg) no-repeat; left:0px; top:0px;}
    80%  {background:url(../image/asia3.jpg) no-repeat;  left:0px; top:0px;}
    100% {background:url(../image/asia3.jpg) no-repeat;  left:0px; top:0px;}
}
 ...
 <div id="gcontent">
  ...
  <li>
    ...
    <div id="grightusable">
        ...
        <p class="popularp"> <em class="adrs">Dhaka</em> <em class="emp"> 10 Km Distance from airportt</em> <br />
   ...
   <h3 class="description">We are happy to announce that Asia Pacific Blossom Hotel just opened on November 01,2001. Its 36 Luxurious rooms including 10 suites, that are widely being appreciated by the Guests. This ornamental building built in its own style. Beautyfully appointed and superbly equipped with modern amenities to cater to the needs of frequent travelers.This hotel is managed by a group of professionals with experience in five star hotel, where you can depend on us to meet your all expectations with five star touches with an affordable price. This Magnificent hotel is unequal led for the warm hospitality and personalized service in harmony with Bangladeshi culture. </h3>
   ...
   <ul class="eachfacul">
    ...
    <div class="sis">
    <h3 class="description">ASIA PACIFIC</h3>
    </div>
    </div>
    ...
    <div class="sis">
    <h3 class="description">14:01:00 PM</h3>
    </div>
    </div>
    ...
    <div class="mainbookitem">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">Rs 14000</h3></div>
     <div class="lprice">
